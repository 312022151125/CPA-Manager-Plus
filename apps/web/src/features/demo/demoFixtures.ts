  ...
  if (requestUrl.includes('/wham/usage')) {
    body = {
      ...
      rate_limit: {
        allowed: true,
        primary_window: {
          used_percent: isCodexPro20x ? 71 : 63,
          limit_window_seconds: 18000,
          reset_after_seconds: isCodexPro20x ? 6120 : 8280,
          reset_at: Math.floor((now() + (isCodexPro20x ? 6120 : 8280) * 1000) / 1000),
        },
        secondary_window: {
          used_percent: isCodexPro20x ? 48 : 42,
          limit_window_seconds: 604800,
          reset_after_seconds: isCodexPro20x ? 198000 : 246000,
          reset_at: Math.floor((now() + (isCodexPro20x ? 198000 : 246000) * 1000) / 1000),
        },
      },
      ...
      credits: {
        has_credits: true,
        unlimited: false,
        balance: isCodexPro20x ? 42.6 : '18.40',
