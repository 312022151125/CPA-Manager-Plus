...
- A manually saved price remains authoritative during synchronization, even when a source returns an exact match for the same model. Replace or delete the manual entry explicitly to use synchronized pricing again.
