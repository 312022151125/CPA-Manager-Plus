...
- If you harden the runtime with a read-only root filesystem or a non-root user, give SQLite a writable temporary directory and a writable database file; see [SQLite Deployment Notes](docs/sqlite-deployment-notes.md).
